...
const Page = () => {
  ...
  const productSales: { [key: string]: { quantity: number; category: string } } = {};
  ...
  return (
    <div>
      <div className="space-y-8 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-2xl font-bold mt-2">
              ৳ {deliveredOrders.reduce((acc, order) => acc + order.totalAmount, 0).toLocaleString()}
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-gray-700">Total Delivery</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold text-gray-700 mb-4">Most Selling Products</h3>
            ...
            <table className="min-w-full table-auto text-left">
              ...
              <tbody>
                {sortedProducts.map(([productName, { quantity }], index) => (
                  <tr key={productName} className="border-b hover:bg-gray-50 text-sm">
...
<div className="bg-white p-6 rounded-lg shadow-md">
  <h3 className="text-xl font-semibold text-gray-700 mb-4">Recent Active Orders</h3>
  <div className="overflow-x-auto">
    <table className="min-w-full table-auto text-left">
      <thead>
        <tr className="text-gray-600 text-sm border-b">
